				...
				<OverlayPortal>
					<div
						className={classNames(
							'ads-tooltip fixed z-[var(--ads-layer-toast)] max-w-[min(20rem,calc(100vw-1rem))] rounded-lg border border-border bg-surface-raised px-3 py-2 font-sans text-text shadow-md',
							className,
						)}
			...
			{open ? (
				<OverlayPortal>
					<div
						{...props}
						className={classNames(
							'ads-popover fixed z-[var(--ads-layer-toast)] max-w-[min(24rem,calc(100vw-1rem))] rounded-lg border border-border bg-surface-raised p-4 text-text shadow-lg max-md:p-3',
							className,
						)}
						id={popoverId}
						ref={contentRef}
