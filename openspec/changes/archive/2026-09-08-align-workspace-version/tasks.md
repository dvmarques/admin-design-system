...
- [x] 2.2 Executar `npm run typecheck`, `npm run build` e `npm run test:e2e`, confirmando que nenhum teste E2E falha; não atualizar snapshots, pois não há alteração visual.
